...
(function(w){
    ...
    legend.prototype = {
        init: function(){
            ...
            element.style.cssText = "border-radius:5px;position:absolute;"+positionCss+"font-family:Helvetica; width:256px; background:rgba(255,255,255,1);padding:10px;border:1px solid black;margin:0;";
