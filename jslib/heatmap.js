...
(function(w){
    ...
    store.prototype = {
        ...
        setDataSet: function(obj, internal,colorize){
            var me = this,
                heatmap = me.get("heatmap"),
                data = [],
                d = obj.data,
            ...
            if (colorize) me.set("actxData","")
            heatmap.colorize();
            console.log("colorize", new Date().valueOf() - start)
            this.set("data", d);
        },
    ...
    heatmap.prototype = {
        ...
        colorize: function(x, y){
                ...
                // loop thru the area
                console.log("getimdata", new Date().valueOf() - start)
                ...
                console.log ("render", new Date().valueOf() - start)
